	...
	<div class="sns-top">
		<ol>
			...
			<?php if( function_exists('scc_get_share_facebook') && ! empty( scc_get_share_facebook() ) ): ?>
				<li class="facebook">
				<a href="http://www.facebook.com/sharer.php?src=bm&u=<?php echo $url_encode;?>&t=<?php echo $title_encode;?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"><i class="jic jin-ifont-facebook-t" aria-hidden="true"></i>&nbsp;<?php if(function_exists('scc_get_share_facebook')) echo (scc_get_share_facebook()==0)?'':scc_get_share_facebook(); ?></a>
				</li>
			<?php else: ?>
				<li class="facebook">
			...
			<?php if( function_exists('scc_get_share_pocket') && ! empty( scc_get_share_pocket() ) ): ?>
				<li class="pocket">
				<a href="http://getpocket.com/edit?url=<?php echo $url_encode;?>&title=<?php echo $title_encode;?>"><i class="jic jin-ifont-pocket" aria-hidden="true"></i>&nbsp;<?php if(function_exists('scc_get_share_pocket')) echo (scc_get_share_pocket()==0)?'':scc_get_share_pocket(); ?></a>
				</li>
			<?php else: ?>
				<li class="pocket">
