							...
							<div class="new-entry" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
								<figure class="eyecatch">
									<?php if (has_post_thumbnail()): ?>
										<?php the_post_thumbnail('cps_thumbnails'); ?>
									...
									<?php else: ?>
										<img src="<?php echo get_jin_noimage_url(); ?>" alt="no image" />
									<?php endif; ?>
								</figure>
							</div>
...
?>
		<div class="my-profile">
			...
			<div class="my-profile-thumb">		
				<a href="<?php echo $myprofile_url; ?>"><img src="<?php echo $cps_ranking01_img; ?>" /></a>
			</div>
