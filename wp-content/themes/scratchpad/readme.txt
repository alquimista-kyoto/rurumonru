...
== Description ==
Scratchpad is a colorful theme for collecting your ideas.
...
Scratchpad includes support for Infinite Scroll in Jetpack.

== Changelog ==

= 30 March 2018 =
* Correct CSS selector for Header Text Color.
...
= 29 August 2017 =
* Ensure IS is turned off when footer widgets are present, or when on a mobile device with an active sidebar.

= 30 June 2017 =
* Add hover effect to social icons in widget.
...
= 21 February 2017 =
* Add background to testimonials.

= 9 February 2017 =
* Check for is_wp_error() in cases when using get_the_tag_list() to avoid potential fatal errors.

= 27 August 2016 =
* Add styles to make sure Jetpack Portfolio projects look like standard posts.
...
= 22 April 2016 =
* Giving glow background a negative z-index so it doesn't overlap widgets.

= 20 April 2016 =
* Fixing issue with WP.com comment form styles.

= 15 April 2016 =
* Add missing span to byline.
...
* Clean up minor issues, including:
...
* Style
* Build out theme styles, including:

= 26 March 2016 =
* Tweaks to theme, including:

= 25 March 2016 =
* Minor theme fixes, including:
...
* Image in screenshot from Unsplash http://unsplash.com, [CC0], https://creativecommons.org/publicdomain/zero/1.0/. Specific photo: https://unsplash.com/photos/1pJjYDJW5HM by Crew.
